...
public class Registry{
	private static HashSet<String> replicaAddrs = new HashSet<String>();
	
	public static void main(String[] args){
		try {
			BufferedReader r = new BufferedReader(new FileReader("replicas.txt"));
			String currentLine;
			while ((currentLine = r.readLine()) != null) {
				if(!currentLine.isEmpty()){
					replicaAddrs.add(currentLine);
				}
			}
		...
		for(String hostAddr: replicaAddrs){
